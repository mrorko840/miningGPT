                                                ...
                                                <td>
                                                    <div class="customer-details d-block">
                                                        <a href="javascript:void(0)">
                                                            <img class="neo-shadow rounded" style="height: 40px; border-radius: 20px!important;" src="{{ asset('assets/images/frontend/' . $key .'/'. @$data->data_values->$firstKey) }}" alt="@lang('image')">
                                                        </a>
                                                    </div>
                                                </td>
                                            @endif
