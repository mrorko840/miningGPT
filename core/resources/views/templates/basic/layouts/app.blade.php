    ...
    <script>
        ...
        const darkModeChange = () => {
            if($('body').hasClass('darkmode')){
                $('.nightModeImg').html(`<img width="28px" src="{{asset('assets/images/3d-logo/sun.png')}}" alt="">`);
            }else{
                $('.nightModeImg').html(`<img width="28px" src="{{asset('assets/images/3d-logo/moon.png')}}" alt="">`);
            }
        }
