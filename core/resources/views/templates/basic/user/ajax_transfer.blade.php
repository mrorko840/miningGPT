...
<form id="transferForm" action="{{ route('user.transfer.submit') }}" method="post" enctype="multipart/form-data">
    ...
    <div class="container mb-4">
        ...
        <div class="form-group mb-1">
            <input type="number" id="transferAmount" step="any" name="amount" class="form-control large-gift-card border transferAmount" value="{{ old('username') }}" placeholder="00.00" required>
        </div>
        <p class="text-center text-secondary mb-4">
            ...
            <input type="text" id="cutAmount" class="form-control text-center text-danger text-no-shadow calculation"
