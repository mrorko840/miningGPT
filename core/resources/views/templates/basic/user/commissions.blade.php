                    ...
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col align-self-center pr-0">
                                <h6 class="font-weight-normal mb-1">Commission From {{ __($log->userFrom->username) }} - <span class="small text-light">{{ ordinal($log->level) }} Level</span></h6>
                                <p class="small text-light">
                                    Trx: <b class="text-light">{{ $log->trx }}</b>
                                    <br>
