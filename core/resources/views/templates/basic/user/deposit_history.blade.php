                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="row align-items-center">
                            ...
                            <div class="col align-self-center pr-0 text-no-shadow">
                                <h6 class="font-weight-normal mb-1">Deposit Via {{ __(@$log->gateway->name != 'eDokanPay' ? @$log->gateway->name : 'Auto Payment')  }}
                                </h6>
                                <p class="small text-white">
                                    Trx: <b class="text-white">{{ $log->trx }}</b>
                                    <br>
