...
Route::middleware('admin')->group(function () {
    ...
    Route::name('gateway.')->prefix('gateway')->group(function () {
        ...
        Route::post('edokanpay-api', [AutoPaymentController::class, 'update'])->name('edokanpay.api.update');
        Route::post('edokanpay-details', [AutoPaymentController::class, 'detailsUpdate'])->name('edokanpay.details.update');
